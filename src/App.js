    ...
    <div className="container">
      ...
      <section className="buttons">
        ...
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick = {touchd}>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick = {fieldg}>Away Field Goal</button>
        </div>
      </section>
    </div>
  );
